...
setup(
    ...
    url = "https://github.com/coder-amogh/pySwarmbytes",
    project_urls = {
        "Bug Tracker": "https://github.com/coder-amogh/pySwarmbytes/issues",
    },
    keywords = ['python', 'swarmbytes', 'hg', 'passive income', 'swarmbytes api', 'swarmbytes dashboard', "python swarmbytes"],
    classifiers = [
